...
pub enum Opcode
{
    ...
    Add,             // add: Add the top 2 elements on the stack. [value1, value2] -> [result]
    Sub,             // sub: Subtract the top 2 elements on the stack. [value1, value2] -> [result]
    Mul,             // mul: Multiply the top 2 elements on the stack. [value1, value2] -> [result]
    Div,             // div: Divide the top 2 elements on the stack. [value1, value2] -> [result]
    Rem,             // rem: Modulus the top 2 elements on the stack. [value1, value2] -> [result]
    Neg,             // neg: Negate the top element on the stack. [value] -> [result]
