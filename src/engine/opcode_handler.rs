...
const HANDLERS: [HandlerInfo; u8::MAX as usize + 1] = handlers!(
    ...
    { Opcode::IfEq,          4, branch, |[y]| y == StackEntry::Unsigned(0) },
    { Opcode::IfNe,          4, branch, |[y]| y != StackEntry::Unsigned(0) },
    { Opcode::IfLt,          4, branch, |[y]| y < StackEntry::Unsigned(0) },
    { Opcode::IfGe,          4, branch, |[y]| y >= StackEntry::Unsigned(0) },
    { Opcode::IfGt,          4, branch, |[y]| y > StackEntry::Unsigned(0) },
    { Opcode::IfLe,          4, branch, |[y]| y <= StackEntry::Unsigned(0) },
    { Opcode::IfEqCmp,       4, branch, |[a, b]| a == b },
    { Opcode::IfNeCmp,       4, branch, |[a, b]| a != b },
    { Opcode::IfLtCmp,       4, branch, |[a, b]| a < b },
    { Opcode::IfGeCmp,       4, branch, |[a, b]| a >= b },
    { Opcode::IfGtCmp,       4, branch, |[a, b]| a > b},
    { Opcode::IfLeCmp,       4, branch, |[a, b]| a <= b },
    { Opcode::Jump,          4, branch, |[]| true },
